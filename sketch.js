...
var eating_sound;
var balloon_btn;
var star2,star1,starImg
var starDisplay
var starImg1,starImg2,emptyStarImg
...
function preload()
{
  ...
  starImg1=loadAnimation('one_star.png')
  starImg2=loadAnimation('stars.png')
...
starDisplay.addAnimation('one',starImg1)
starDisplay.addAnimation('two',starImg2)
...
starDisplay.scale=0.2
  ...
  button.mouseClicked(drop);
   ...
   balloon_btn.position(300,370)
   balloon_btn.size(120,120)
...
star1=createSprite(330,50)
star1.addImage(starImg)
star1.scale=0.02

star2=createSprite(100,370)
